...
from models_provider.impl.api_route_model_provider.api_route_model_provider import ApiRouteModelProvider
...
class ModelProvideConstants(Enum):
    ...
    model_api_route_provider = ApiRouteModelProvider()
